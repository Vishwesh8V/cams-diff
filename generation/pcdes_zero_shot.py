...
cams_generation_DIR = os.path.join(
    PROJECT_ROOT,
    "cams_generation"
)
...
sys.path.insert(0, cams_generation_DIR)
...
import cams_generation.dist_util as dist_util
import cams_generation.gaussian_diffusion as gd

from cams_generation.respace import SpacedDiffusion

from cams_generation.transformer_model2 import (
...
def build_model(
    ...
    print()
    print("=" * 90)
    print("CREATING CAMS-Diff MODEL")
    print("=" * 90)
...
def main():
    ...
    print(
        "Cams diff PCDes ZERO-SHOT EVALUATION"
    )
