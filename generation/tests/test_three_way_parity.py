...
ROOT_ADANOISE = os.path.abspath(os.path.join(ROOT_MERGED, '..', ''))
ROOT_MIXEDSPACE = os.path.abspath(os.path.join(ROOT_MERGED, '..', ''))

def run_isolated(code, root_dir):
    script = f"""
import sys, os, tempfile
sys.path.insert(0, os.path.join(r'{root_dir}', 'cams_generation'))
sys.path.insert(0, os.path.join(r'{root_dir}', 'cams_generation', 'scripts'))
