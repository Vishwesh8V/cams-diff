...
from cams_generation.test_util import  load_results
...
def main():
    ...
    if args.mode == 'tree':
        ...
        control_label_lst = []
        with open('diffusion_lm/cams_generation/control_gen/target_tree.json', 'r') as controlf:
    ...
    if args.mode == 'spans':
        ...
        control_label_lst = []
        with open('diffusion_lm/cams_generation/control_gen/target_spans.json', 'r') as controlf:
            for line in controlf:
                control_label_lst.append(json.loads(line))
