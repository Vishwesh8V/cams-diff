    ...
    if mode in ['random', 'random1', 'random_up_proj', 'glove']:
        if modality == 'synth':
            ...
            if modality == 'book' or (extra_args is not None and extra_args.use_bert_tokenizer == 'yes'):
                ...
                path_save_tokenizer = '/data0/gonghaisong/Diffusion-LM/cams_generation/diffusion_models/diff_e2e-tgt_block_rand16_transformer_lr0.0001_0.0_2000_sqrt_Lsimple_h128_s2_d0.1_sd102_xstart_e2e/vocab.json'
