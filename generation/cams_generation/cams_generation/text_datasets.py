...
def get_corpus_rocstory(data_args, model, image_size, padding_mode='block',
    ...
    if data_args.experiment_mode == 'lm':
        ...
        if data_args.modality == 'roc-aug':
            ...
            if split == 'train':
                ...
                path_lst.append('diffusion_lm/cams_generation/diff_models/rocstories_gptj.txt')
            elif split == 'valid':
                print('loading form the VALID set')
                path = f'{data_args.commonGen_train}/commongen.dev.jsonl'
                path_lst = []
    ...
    if load_vocab is None:
        ...
        path_save_vocab = '/data0/gonghaisong/Diffusion-LM/cams_generation/diffusion_models/diff_e2e-tgt_block_rand16_transformer_lr0.0001_0.0_2000_sqrt_Lsimple_h128_s2_d0.1_sd102_xstart_e2e/vocab.json'
    ...
    if model is None and data_args.experiment == 'random':
        ...
        path_save = '/data0/gonghaisong/Diffusion-LM/cams_generation/diffusion_models/diff_e2e-tgt_block_rand16_transformer_lr0.0001_0.0_2000_sqrt_Lsimple_h128_s2_d0.1_sd102_xstart_e2e/random_emb.torch'
