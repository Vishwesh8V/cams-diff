    ...
    if args.modality in ['synth', 'pos']:
        ...
        if args.eval_task_ == 'infill':
            ...
            if args.eval_task_ == 'control_attribute':
                ...
                control_label_lst = []
                with open('diffusion_lm/cams_generation/control_gen/target_attribute.json', 'r') as controlf:
            ...
            if args.eval_task_ == 'control_attribute_compose':
                ...
                ################33
                control_label_lst = []
                with open('diffusion_lm/cams_generation/control_gen/target_pos.json', 'r') as controlf:
                    for line in controlf:
                        control_label_lst.append(json.loads(line))
                print(control_label_lst[:5])
                control_constraints = []
                ...
                ###############
                control_label_lst = []
                with open('diffusion_lm/cams_generation/control_gen/target_tree.json',
                          'r') as controlf:
                    for line in controlf:
                        control_label_lst.append(json.loads(line))
                ...
                ###############
                control_label_lst = []
                with open('diffusion_lm/cams_generation/control_gen/target_spans.json',
                          'r') as controlf:
                    for line in controlf:
                        control_label_lst.append(json.loads(line))
                # print(control_label_lst[:1])
