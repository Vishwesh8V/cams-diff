...
CAMS_DIFFUSION_DIR = os.path.abspath(os.path.join(SCRIPT_DIR, ".."))
...
def build_model_and_tokenizer(args):
    from cams_generation import dist_util
...
def build_diffusion(args, tokenizer):
    ...
    *and* have load_adaptive_schedule() called on it -- otherwise the
    ...
    from cams_generation import logger
...
def create_argparser():
    from cams_generation.script_util import model_and_diffusion_defaults, add_dict_to_argparser
