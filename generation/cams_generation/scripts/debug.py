...
from cams_generation.text_datasets import load_data_text, load_synthetic_data
...
from cams_generation.test_util import get_weights, denoised_fn_round, compute_logp
from cams_generation.gaussian_diffusion import _extract_into_tensor
...
def main():
    ...
    if args.modality == 'image':
        ...
        from cams_generation.rounding import load_models
