...
from cams_captioning import gaussian_diffusion as gd
from cams_captioning.gaussian_diffusion import SpacedDiffusion, space_timesteps
from cams_captioning.transformer_model import TransformerNetModel
...
def load_defaults_config():
    ...
    """
    with open('cams_captioning/config.json', 'r') as f:
        return json.load(f)
